...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, t):
        ...
        x = self.pretrained_embeddings(t)   # (batch_size, n_features, embedding_size)
        x = x.view(x.size()[0], -1)         # (batch_size, n_features * embedding_size)
    ...
    def forward(self, t):
        ...
        hidden = self.dropout(F.relu(self.embed_to_hidden(embeddings)))
